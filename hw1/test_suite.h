...
#ifndef _HW1_TEST_SUITE_H_
#define _HW1_TEST_SUITE_H_

// Add points to the HW1 point total.
void HW1Addpoints(unsigned int points);

// Reset the point total to zero (for debugging only).
void HW1ResetPoints();

#endif  // _HW1_TEST_SUITE_H_

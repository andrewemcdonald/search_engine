...
#ifndef _HW4_TEST_SERVERSOCKET_H_
#define _HW4_TEST_SERVERSOCKET_H_

#include "gtest/gtest.h"

namespace hw4 {

class Test_ServerSocket : public ::testing::Test {
 protected:
  Test_ServerSocket() {
    // Do set-up work for each test here.
  }

  virtual ~Test_ServerSocket() {
  ...
  // the test case.
};  // class Test_ServerSocket

}  // namespace hw4

#endif  // _HW4_TEST_SERVERSOCKET_H_

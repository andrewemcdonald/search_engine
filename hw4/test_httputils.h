...
#ifndef _HW4_TEST_HTTPUTILS_H_
#define _HW4_TEST_HTTPUTILS_H_

#include "gtest/gtest.h"

namespace hw4 {

class Test_HttpUtils : public ::testing::Test {
 protected:
  Test_HttpUtils() {
    // Do set-up work for each test here.
  }

  virtual ~Test_HttpUtils() {
  ...
  // the test case.
};  // class Test_HttpUtils

}  // namespace hw4

#endif  // _HW4_TEST_HTTPUTILS_H_

...
#ifndef _HW4_TEST_FILEREADER_H_
#define _HW4_TEST_FILEREADER_H_

#include "gtest/gtest.h"

namespace hw4 {

class Test_FileReader : public ::testing::Test {
 protected:
  Test_FileReader() {
    // Do set-up work for each test here.
  }

  virtual ~Test_FileReader() {

...
#ifndef _HW2_TEST_FILECRAWLER_H_
#define _HW2_TEST_FILECRAWLER_H_

#include "gtest/gtest.h"

namespace hw2 {

class Test_FileCrawler : public ::testing::Test {
 protected:
  Test_FileCrawler() {
    // Do set-up work for each test here.
  }

  virtual ~Test_FileCrawler() {
  ...
  // the test case.
};  // class Test_FileCrawler

}  // namespace hw2

#endif  // _HW2_TEST_FILECRAWLER_H_
